...
#####
# This is a custom 'getting started' script, made with care for zidios101@gmail.com.
...
streamer = Streamer(bucket_name="Python Stream Example", bucket_key="python_example", access_key="ist_PxI02ioOp4KEOeDtd2VfPyWpDdEZ82h6")
